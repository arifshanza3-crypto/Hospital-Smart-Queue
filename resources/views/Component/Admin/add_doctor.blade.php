...
<style>
    ...
    .add-doctor-wrapper { padding: 24px 28px; background: var(--bg-primary); min-height: 100vh; }
    ...
    .btn-secondary-gradient:hover { background: #cbd5e1; color: var(--text-primary); text-decoration: none; }
    ...
    .btn-primary-gradient {
        ...
        display: inline-flex; align-items: center; gap: 10px;
        font-weight: 600; font-size: 14px; transition: all 0.3s ease;
        border: none; cursor: pointer; box-shadow: 0 4px 16px rgba(59, 130, 246, 0.25);
    }
    ...
    .form-card-header h3 i { color: var(--accent-1); }
    ...
    .form-group label i { color: var(--accent-1); margin-right: 6px; width: 18px; }
    ...
    .alert-modern.success { border-color: var(--success); color: #065f46; }
    .alert-modern.success i { color: var(--success); }
    .alert-modern.error { border-color: var(--danger); color: #991b1b; }
    .alert-modern.error i { color: var(--danger); }
    .alert-modern i { font-size: 18px; }
    .alert-modern ul { margin: 0; padding-left: 20px; }
    .alert-modern ul li { list-style-type: disc; }
    ...
    .form-actions .btn-secondary-gradient { flex: 0.5; }

    @media (max-width: 768px) {
        .add-doctor-wrapper { padding: 16px; }
        .page-header-left h1 { font-size: 22px; }
        .form-card-body { padding: 16px; }
        .form-actions { flex-direction: column; }
        .form-actions .btn { width: 100%; justify-content: center; flex: 1; }
    }

    @media (max-width: 576px) {
        .add-doctor-wrapper { padding: 12px; }
        .page-header-left h1 { font-size: 18px; }
        .btn-primary-gradient, .btn-secondary-gradient { padding: 10px 20px; font-size: 13px; }
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            <form method="POST" action="{{ route('admin.doctors.store') }}">
                ...
                <div class="form-group">
                    <label for="specialization"><i class="fas fa-stethoscope"></i> Specialization <span class="required">*</span></label>
                ...
                <div class="form-group">
                    <label for="status"><i class="fas fa-toggle-on"></i> Status <span class="required">*</span></label>
                ...
                <div class="form-group">
                    <label for="staff_id">
                        <i class="fas fa-user-tie"></i> Assign Staff <span class="optional">(Optional)</span>
                    </label>
                    ...
                    <div class="field-hint">
                        <i class="fas fa-info-circle"></i> Select a staff member to assign this doctor to them
                    </div>
                </div>
